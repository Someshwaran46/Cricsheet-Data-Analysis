...
json_dir = r"C:\Users\Hp\OneDrive\Documents\Guvi\Cricsheet\cricsheet_json_downloads\tests_json"
...
print(f"Successfully inserted {len(all_deliveries)} records into MySQL database under table 'Tests'.")
