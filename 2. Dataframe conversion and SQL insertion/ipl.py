...
json_dir = r"C:\Users\Hp\OneDrive\Documents\Guvi\Cricsheet\cricsheet_json_downloads\ipl_json"
...
print(f"Successfully inserted {len(all_deliveries)} records into MySQL database under table 'IPL'.")
