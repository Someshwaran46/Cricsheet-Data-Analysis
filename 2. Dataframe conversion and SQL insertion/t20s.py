...
json_dir = r"C:\Users\Hp\OneDrive\Documents\Guvi\Cricsheet\cricsheet_json_downloads\t20s_json"
...
create_table_query = """
CREATE TABLE IF NOT EXISTS t20s (
...
print(f"Successfully inserted {len(all_deliveries)} records into MySQL database under table 'T20s'.")
